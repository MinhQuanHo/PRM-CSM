...
public class OrderEmployeeAdapter extends RecyclerView.Adapter<OrderEmployeeAdapter.MyViewHolder> {
    ...
    Context context;
    private OrderEmployeeAdapter.OnItemClickListener onItemClickListener;
    ...
    public void setOnItemClickListener(OrderEmployeeAdapter.OnItemClickListener listener) {
