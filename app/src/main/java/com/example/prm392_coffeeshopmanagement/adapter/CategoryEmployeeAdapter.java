...
import com.example.prm392_coffeeshopmanagement.activity.CategoryListEmployeeActivity;
...
public class CategoryEmployeeAdapter extends RecyclerView.Adapter<CategoryEmployeeAdapter.MyViewHolder> {
    private static List<Category> categories;
    private int userId;
    private UserViewModel userViewModel;
    private CategoryEmployeeAdapter.OnItemClickListener onItemClickListener;
    ...
    public static void setCategoryList(List<Category> categories) {
        CategoryEmployeeAdapter.categories = categories;
    }
    ...
    public CategoryEmployeeAdapter(List<Category> categories, int userId) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.deleteButton.setOnClickListener(v -> {
            if (holder.itemView.getContext() instanceof CategoryListEmployeeActivity) {
                ((CategoryListEmployeeActivity) holder.itemView.getContext()).showDeleteDialog(category);
            }
        });
    }
