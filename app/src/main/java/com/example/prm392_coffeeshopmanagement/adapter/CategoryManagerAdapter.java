...
import com.example.prm392_coffeeshopmanagement.activity.CategoryListManagerActivity;
...
public class CategoryManagerAdapter extends RecyclerView.Adapter<CategoryManagerAdapter.MyViewHolder> {
    ...
    private CategoryManagerAdapter.OnItemClickListener onItemClickListener;
